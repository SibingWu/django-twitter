...
SECRET_KEY = '*2iak6(048f=f0s#pn$#_@n+pl5pdbc^$-81a3jayb8fa6k$!o'
...
AWS_STORAGE_BUCKET_NAME = 'django-twitter-sibing'
AWS_S3_REGION_NAME = 'ap-southeast-1'

# 还需要在 local_settings.py 中设置 AWS_ACCESS_KEY_ID 和 AWS_SECRET_ACCESS_KEY
...
# memcached 安装方法：'sudo apt-get install memcached'
